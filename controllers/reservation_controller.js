...
export const createReservation = asyncWrapper(
  async (req,res) => {
    const {user, technician, date, time} = req.body
    
    let reservation = await ReservationRepository.createReservation({user, technician, date, time})
    console.log(reservation);
    return res.status(OK).json(reservation)
  }
)

export const completeReservation = asyncWrapper(
  async (req,res) => {
    const {id} = req.params
    let reservation = await ReservationRepository.completeReservation(id)
    console.log(reservation)
    return res.status(OK).json(reservation)
  }
)

export const getUserReservations = asyncWrapper(
  async (req,res) => {
    const {id} = req.params
    
    let reservation = await ReservationRepository.getUserReservations(id)
    console.log(reservation)
    return res.status(OK).json(reservation)
  }
)
...
export const getAllReservations = asyncWrapper(
  async (req,res) => {
    let reservation = await ReservationRepository.getAllReservations()
    console.log(reservation)
    return res.status(OK).json(reservation)
  }
)

export const deleteReservation = asyncWrapper(
  async (req,res) => {
    const {id} = req.params
    let reservation = await ReservationRepository.deleteReservation(id)
    console.log(reservation)
    return res.status(OK).json(reservation)
  }
)

export const deleteAllReservations = asyncWrapper(
  async (req,res) => {
    let reservation = await ReservationRepository.deleteAllReservations()
    console.log(reservation)
    return res.status(OK).json(reservation)
  }
)

export const getAllReservationsCount = asyncWrapper(
  async (req,res) => {
    let reservation = await ReservationRepository.getAllReservationsCount()
    console.log(reservation)
    return res.status(OK).json(reservation)
  }
)
